  ...
  return (
   <>
    <div className="p-4 sm:ml-64 mt-20">
            ...
            <div className='rounded-xl mt-5 p-0 py-3 bg-gradient-to-r from-green-500'>
                <h2 className="text-2xl text-center font-bold leading-none tracking-tight text-white lg:text-3xl">Send Simple Text Messages</h2>
            </div>
            <form className="mb-6 md:grid-cols-2 mt-10 w-1/2">
                <div className="relative z-0 w-full mb-5 group">
                    <label htmlFor="phone-input" className="block mb-2 text-xl font-semibold text-green-500 dark:text-white">Phone number:</label>
                ...
                <div className="relative z-0 w-full mb-5 group">
                    <label htmlFor="message" className="block mb-2 text-xl font-semibold text-green-500 dark:text-white">Your message:</label>
                ...
                <div className="text-center">
                    <button type="submit" className="text-white w-full bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 shadow-lg shadow-green-500/50 dark:shadow-lg dark:shadow-green-800/80 font-medium rounded-lg text-lg sm:px-36 py-3.5 text-center me-2 mb-2 ">Send Message</button>
                </div>
            </form>
    </div>
   </>
